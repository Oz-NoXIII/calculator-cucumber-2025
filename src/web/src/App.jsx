...
import {Tabs,
  TabsContent,
  TabsList,
  TabsTrigger,} from "./components/tabs.jsx";

const calculator_buttons = [
  [
    { label: '2nd', value: '2nd', disabled: false, second: null },
    { label: <PiIcon />, value: 'pi', disabled: true, second: { label: 'const', value: 'const', disabled: true } },
    { label: 'e', value: 'e', disabled: true, second: { label: 'j', value: 'j', disabled: false } },
    { label: '[::]', value: '[::]', disabled: true, second: null },
    { label: 'x', value: 'x', disabled: true, second: { label: '=', value: '=', disabled: true } },
    { label: '(', value: '(', disabled: false, second: { label: '[', value: '[', disabled: true } },
  ...
  [
    { label: 'sin', value: 'sin', disabled: true, second: { label: 'sin⁻¹', value: 'asin', disabled: true }},
    { label: 'sinh', value: 'sinh', disabled: true, second: { label: 'sinh⁻¹', value: 'asinh', disabled: true } },
    { label: 'cot', value: 'cot', disabled: true, second: { label: 'cot⁻¹', value: 'acot', disabled: true } },
  ...
  [
    { label: 'cos', value: 'cos', disabled: true, second: { label: 'cos⁻¹', value: 'acos', disabled: true } },
    { label: 'cosh', value: 'cosh', disabled: true, second: { label: 'cosh⁻¹', value: 'acosh', disabled: true } },
    { label: 'sec', value: 'sec', disabled: true, second: { label: 'sec⁻¹', value: 'asec', disabled: true } },
  ...
  [
    { label: 'tan', value: 'tan', disabled: true, second: { label: 'tan⁻¹', value: 'atan', disabled: true } },
    { label: 'tanh', value: 'tanh', disabled: true, second: { label: 'tanh⁻¹', value: 'atanh', disabled: true } },
    { label: 'csc', value: 'csc', disabled: true, second: { label: 'csc⁻¹', value: 'acsc', disabled: true } },
  ...
  [
    { label: 'lsh', value: 'rsh', disabled: true, second: { label: 'rol', value: 'rol', disabled: true } },
    { label: 'rsh', value: 'rsh', disabled: true, second: { label: 'ror', value: 'ror', disabled: true } },
    { label: '', value: '', disabled: true, second: null},
...
export default function App() {
  ...
  return (
    <div className="px-6 py-30 gap-20 flex bg-black/95 justify-start items-start h-screen">
      <div className="border max-w-3xl w-full rounded-lg bg-white h-full flex flex-col justify-start items-center p-4 shadow-xs">
        ...
        <p className="mt-3 text-xs text-muted-foreground/40">By Arsène Mujyabwami, Ingrid Fondja Tchoumba, Nicolas Delplanque and Xavier Delabie </p>
      </div>
      <div className="flex flex-col gap-6 justify-start items-start h-full w-full bg-white rounded-md p-4">
        ...
        >
          ...
          <div className="grow rounded-md border text-start">
            <TabsContent value="tab-1" className="py-3 px-4 grid gap-3 grid-cols-2">
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="grid pl-4 text-sm">
                  <p>
                    <span className="font-bold">Addition :</span> +(a, b) <span className="text-muted-foreground/60 font-medium text-xs">or</span> +(a b)
                  </p>
                  <p>
                    <span className="font-bold">Subtraction :</span> -(a, b) <span className="text-muted-foreground/60 font-medium text-xs">or</span> -(a b)
                  </p>
                  <p>
                    <span className="font-bold">Multiplication :</span> *(a, b) <span className="text-muted-foreground/60 font-medium text-xs">or</span> *(a b)
                  </p>
                  <p>
                    <span className="font-bold">Division :</span> /(a, b) <span className="text-muted-foreground/60 font-medium text-xs">or</span> /(a b)
                  </p>
                  <p>
                    <span className="font-bold">Exponentiation :</span> ^(a, b) <span className="text-muted-foreground/60 font-medium text-xs">or</span> ^(a b)
                  </p>
                  <p>
                    <span className="font-bold">Negation :</span> (-(a))
                  </p>
