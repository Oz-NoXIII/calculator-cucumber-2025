...
class Tangent(Function):
    """
    This class represents the arithmetic sum operation "tan".
    ...
    def __init__(self, elist, n=None):
        """
        Class constructor specifying a number of Expressions to tangent,
        as well as the Notation used to represent the operation.
        :param elist: The list of Expressions to tan
    ...
    def op(self, base):
        """
        The actual computation of the tangent
