...
class TestTangent(unittest.TestCase):
    ...
    def setUp(self):
        ...
        params4 = [self.value4]
        try:
            self.op = Tangent(params)
            self.op2 = Tangent(params2)
            self.op3 = Tangent(params3)
            self.op4 = Tangent(params4)
        except IllegalConstruction as e:
            self.fail(e)

    def test_constructor(self):
        self.assertRaises(IllegalConstruction, lambda: Tangent(None))
        try:
    ...
    def test_none_param_list(self):
        params = None
        self.assertRaises(IllegalConstruction, lambda: Tangent(params))
