...
class TestCosinus(unittest.TestCase):
    ...
    def setUp(self):
        ...
        params4 = [self.value4]
        try:
            self.op = Cosinus(params)
            self.op2 = Cosinus(params2)
            self.op3 = Cosinus(params3)
            self.op4 = Cosinus(params4)
        except IllegalConstruction as e:
            self.fail(e)

    def test_constructor(self):
        self.assertRaises(IllegalConstruction, lambda: Cosinus(None))
        try:
    ...
    def test_none_param_list(self):
        params = None
        self.assertRaises(IllegalConstruction, lambda: Cosinus(params))
